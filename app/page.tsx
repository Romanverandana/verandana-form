          ...
          <div className={`${styles.grid} ${styles.two}`}>
            ...
            <div>
              ...
              <div className={styles.phoneInputWrapper}>
                <PhoneInput id="phone" name="phone" className={styles.phoneInput} placeholder="Wpisz numer telefonu" value={formState.values.phone} onChange={(value) => handleInputChange('phone', value || '')} defaultCountry="PL" international />
              </div>
            ...
            <div>
              ...
              <input id="email" name="email" type="email" placeholder="jan.kowalski@example.com" value={formState.values.email} onChange={(e) => handleInputChange('email', e.target.value)} />
            ...
            <div>
              ...
              <input id="postal" name="postal" type="text" placeholder="00-000" value={formState.values.postal} onChange={(e) => handleInputChange('postal', e.target.value)} />
            </div>
          </div>
